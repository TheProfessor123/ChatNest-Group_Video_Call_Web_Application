...
let joinStream = async () => {
    ...
    }})*/ // High-Quality Camera Config - May cause issues as more users join the room

    localTracks = await AgoraRTC.createMicrophoneAndCameraTracks() // Default Camera Quality Config
